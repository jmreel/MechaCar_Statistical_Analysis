...
When looking at the “Total Summary” of all manufacturing lots the variance of the coils is 62.29, which is within the 100 PSI variance that is needed. If we look at the Lot Summary figure Lot1 and Lot2 are within the variance with 0.98 and 7.47 variance. Lot3 has a variance of 170.29, which is not within the 100 PSI requirements.
